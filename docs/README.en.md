...
| RAGBAZ Bridge plugin                                                                                                                   | GraphQL glue for LearnPress (courses/lessons + price/duration/curriculum) and generic events (Event Organiser / The Events Calendar / Events Manager) without bundling third-party code. | Auto-detected. Install from WordPress Plugins (upload ZIP from `https://ragbaz.xyz/downloads/ragbaz-bridge/ragbaz-bridge.zip`) and activate. |
