...
it("detects Swedish by keyword", () => assert.equal(detectLanguage("vad är det som händer"), "Swedish"));
it("detects Spanish by keyword", () => assert.equal(detectLanguage("no lo sé en absoluto"), "Spanish"));
