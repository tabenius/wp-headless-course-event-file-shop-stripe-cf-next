export const ADMIN_TAB_HOTKEYS = [
  ...
  { tab: "contacts", combo: "Ctrl+Alt+4", match: { code: "Digit4", key: "4" } },
  { tab: "support", combo: "Ctrl+Alt+5", match: { code: "Digit5", key: "5" } },
  { tab: "style", combo: "Ctrl+Alt+6", match: { code: "Digit6", key: "6" } },
];
