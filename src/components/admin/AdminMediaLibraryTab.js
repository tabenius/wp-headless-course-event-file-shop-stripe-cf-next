...
import MediaLibraryTable from "@/components/admin/media-library/MediaLibraryTable";
import MediaUploadPanel from "@/components/admin/media-library/MediaUploadPanel";
  ...
  return (
    <div className="border rounded p-5 space-y-4 bg-white min-w-0">
      ...
      <MediaUploadPanel
        ...
        enabledUploadOptions={enabledUploadOptions}
        selectedUploadBackend={selectedUploadBackend}
        setSelectedUploadBackend={setSelectedUploadBackend}
        uploading={uploading}
        ...
        handleDropZonePaste={handleDropZonePaste}
        handleDropZoneDragEnter={handleDropZoneDragEnter}
        ...
        setFlashFocusedItemId={setFlashFocusedItemId}
      ...
      <MediaLibraryTable
        ...
        handleMediaTableKeyDown={handleMediaTableKeyDown}
        resolveAssetLineageRole={resolveAssetLineageRole}
        hasDerivationsForItem={hasDerivationsForItem}
        registerMediaRowRef={registerMediaRowRef}
        flashFocusedItemId={flashFocusedItemId}
        lastOpenedAt={lastOpenedAt}
        openViewer={openViewer}
        productAssetIds={productAssetIds}
        creatingProductFromAsset={creatingProductFromAsset}
        createProductFromAsset={createProductFromAsset}
        openEditor={openEditor}
        openDerivationFlow={openDerivationFlow}
        focusedAssetLineage={focusedAssetLineage}
        focusItemById={focusItemById}
        setShowFocusedLineageOnly={setShowFocusedLineageOnly}
        showFocusedLineageOnly={showFocusedLineageOnly}
        copyUrl={copyUrl}
        copiedUrl={copiedUrl}
      />
