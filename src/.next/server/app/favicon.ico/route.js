          ...
          if (a) {
            ...
            if (b)
              switch (b.type) {
                ...
                case "prerender-ppr":
                  return (0, f.postponeWithTracking)(
                    a.route,
                    "connection",
                    b.dynamicTracking,
                  );
                case "prerender-legacy":
                  return (0, f.throwToInterruptStaticGeneration)(
                    "connection",
                    a,
                    b,
                  );
      ...
      8729: (a, b, c) => {
        ...
        let x = "force-static",
          y = new e.AppRouteRouteModule({
            ...
            relativeProjectDir: "",
            resolvedPagePath:
              "next-metadata-route-loader?filePath=%2Fhome%2Fxyzzy%2Fheadless%2Fhwptoolkit%2Fexamples%2Fnext%2Fclient-app-router-fetch-data%2Fexample-app%2Fsrc%2Fapp%2Ffavicon.ico&isDynamicRouteExtension=0!?__next_metadata_route__",
            nextConfigOutput: "",
            userland: d,
          }),
