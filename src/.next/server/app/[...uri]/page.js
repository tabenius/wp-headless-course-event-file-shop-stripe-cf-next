...
(() => {
  ...
  ((a.id = 155),
    ...
    (a.modules = {
      ...
      5781: (a, b, c) => {
        (c.r(b), c.d(b, { default: () => h, generateStaticParams: () => i }));
        var d = c(7586),
          e = c(3369);
        (!(function () {
          var a = Error(
            "Cannot find module '@/lib/fragments/SingleEventFragment'",
          );
          throw ((a.code = "MODULE_NOT_FOUND"), a);
        })(),
          (function () {
            var a = Error(
              "Cannot find module '@/lib/fragments/SinglePageFragment'",
            );
            throw ((a.code = "MODULE_NOT_FOUND"), a);
          })(),
          (function () {
            var a = Error(
              "Cannot find module '@/lib/fragments/SinglePostFragment'",
            );
            throw ((a.code = "MODULE_NOT_FOUND"), a);
          })(),
          (function () {
            var a = Error("Cannot find module '@/components/single/Page'");
            throw ((a.code = "MODULE_NOT_FOUND"), a);
          })(),
          (function () {
            var a = Error("Cannot find module '@/components/single/Post'");
            throw ((a.code = "MODULE_NOT_FOUND"), a);
          })(),
          (function () {
            var a = Error("Cannot find module '@/components/single/Event'");
            throw ((a.code = "MODULE_NOT_FOUND"), a);
          })(),
          (function () {
            var a = Error("Cannot find module '@/lib/client'");
            throw ((a.code = "MODULE_NOT_FOUND"), a);
          })());
        let f = `
  ${Object(
    (function () {
      var a = Error("Cannot find module '@/lib/fragments/SingleEventFragment'");
      throw ((a.code = "MODULE_NOT_FOUND"), a);
    })(),
  )}
  ${Object(
    (function () {
      var a = Error("Cannot find module '@/lib/fragments/SinglePageFragment'");
      throw ((a.code = "MODULE_NOT_FOUND"), a);
    })(),
  )}
  ${Object(
    (function () {
      var a = Error("Cannot find module '@/lib/fragments/SinglePostFragment'");
      throw ((a.code = "MODULE_NOT_FOUND"), a);
    })(),
  )}
...
`;
        ...
        async function h({ params: a }) {
          let b = await a,
            c = Array.isArray(b?.uri) ? b.uri.join("/") : "",
            f = await g(c);
          f?.nodeByUri ||
            (console.warn("No nodeByUri data found, returning 404"),
            (0, e.notFound)());
          let h = f?.nodeByUri?.__typename;
          return "Post" === h
            ? (0, d.jsx)(
                Object(
                  (function () {
                    var a = Error(
                      "Cannot find module '@/components/single/Post'",
                    );
                    throw ((a.code = "MODULE_NOT_FOUND"), a);
                  })(),
                ),
            ...
            : "Page" === h
              ? (0, d.jsx)(
                  Object(
                    (function () {
                      var a = Error(
                        "Cannot find module '@/components/single/Page'",
                      );
                      throw ((a.code = "MODULE_NOT_FOUND"), a);
                    })(),
                  ),
              ...
              : "Event" === h
                ? (0, d.jsx)(
                    Object(
                      (function () {
                        var a = Error(
                          "Cannot find module '@/components/single/Event'",
                        );
                        throw ((a.code = "MODULE_NOT_FOUND"), a);
                      })(),
                    ),
      ...
      6832: (a, b, c) => {
        ...
        let H = {
            children: [
                ...
                children: [
                  "[...uri]",
                  {
                    children: [
                      ...
                      {
                        page: [
                          () => Promise.resolve().then(c.bind(c, 5781)),
                          "/home/xyzzy/headless/hwptoolkit/examples/next/client-app-router-fetch-data/example-app/src/app/[...uri]/page.js",
                        ],
                      },
                    ],
                  },
                  {
                    metadata: {
                      icon: [
                        async (a) =>
                          (
                            await Promise.resolve().then(c.bind(c, 1077))
                          ).default(a),
                      ],
                      apple: [],
                      openGraph: [],
              ...
              {
                layout: [
                  () => Promise.resolve().then(c.bind(c, 5562)),
                  "/home/xyzzy/headless/hwptoolkit/examples/next/client-app-router-fetch-data/example-app/src/app/layout.js",
                ],
                "global-error": [
                ...
                "not-found": [
                  () => Promise.resolve().then(c.t.bind(c, 8876, 23)),
                  "next/dist/client/components/builtin/not-found.js",
                ],
                forbidden: [
                  () => Promise.resolve().then(c.t.bind(c, 4994, 23)),
                  "next/dist/client/components/builtin/forbidden.js",
                ],
                unauthorized: [
                  () => Promise.resolve().then(c.t.bind(c, 6392, 23)),
                  "next/dist/client/components/builtin/unauthorized.js",
                ],
                metadata: {
                  icon: [
                    async (a) =>
                      (await Promise.resolve().then(c.bind(c, 1077))).default(
                        a,
                      ),
                  ],
                  apple: [],
              ...
              m = async ({ span: e, postponed: f, fallbackRouteParams: g }) => {
                let i = {
                    ...
                    renderOpts: {
                      ...
                      dir: c(3873).join(process.cwd(), K.relativeProjectDir),
                      isDraftMode: _,
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [775, 310, 135], () => b((b.s = 6832)));
  module.exports = c;
})();
