                    ...
                    children: [
                      "[...slug]",
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 8611)),
                              "/home/xyzzy/headless/hwptoolkit/examples/next/client-app-router-fetch-data/example-app/src/app/tag/[...slug]/page.js",
                            ],
                          },
                        ],
                      },
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      8611: (a, b, c) => {
        ...
        (c.r(b),
          ...
          (function () {
            var a = Error(
              "Cannot find module '@/lib/fragments/PostListFragment'",
            );
            throw ((a.code = "MODULE_NOT_FOUND"), a);
          })(),
          (function () {
            var a = Error(
              "Cannot find module '@/components/blog/BlogListingTemplate'",
            );
            throw ((a.code = "MODULE_NOT_FOUND"), a);
          })());
        let d = `
  ${Object(
    (function () {
      var a = Error("Cannot find module '@/lib/fragments/PostListFragment'");
      throw ((a.code = "MODULE_NOT_FOUND"), a);
    })(),
  )}
