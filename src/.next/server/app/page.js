...
(() => {
  ...
  ((a.id = 974),
    ...
    (a.modules = {
      ...
      1844: (a, b, c) => {
        (c.r(b), c.d(b, { default: () => g, generateStaticParams: () => h }));
        var d = c(7586),
          e = c(3369);
        (!(function () {
          var a = Error(
            ...
            children: [
              "",
              {
                children: [
                  ...
                  {
                    page: [
                      () => Promise.resolve().then(c.bind(c, 1844)),
                      "/home/xyzzy/headless/hwptoolkit/examples/next/client-app-router-fetch-data/example-app/src/app/page.js",
                    ],
                    metadata: {
                      icon: [
                        async (a) =>
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [775, 310, 135], () => b((b.s = 8656)));
  module.exports = c;
})();
