...
= How does the storefront detect the plugin? =
Call `ragbazInfo { version hasLearnPress hasEventsPlugin }` in WPGraphQL. The included Next.js storefront already checks this in its admin health screen.
